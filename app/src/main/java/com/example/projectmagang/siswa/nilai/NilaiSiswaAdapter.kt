...
import com.example.projectmagang.data.DataNilai
import kotlinx.android.synthetic.main.cardsiswa_nilai.view.*
import java.text.DecimalFormat

class NilaiSiswaAdapter (val context: Context, var dataNilai: ArrayList<DataNilai>): RecyclerView.Adapter<NilaiSiswaAdapter.ViewHolder>() {
