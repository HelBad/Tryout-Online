...
class MapelSoalAdapter (val context : Context, var dataMapel : ArrayList<DataMapel>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int)=
        ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.cardmapel_kelas, parent, false))
    ...
    override fun onBindViewHolder(holder: MapelSoalAdapter.ViewHolder, position: Int) {
        ...
        else { holder.bing(dataMapel[position], dataMapel[position-1].nama_kelas.toString()) }
