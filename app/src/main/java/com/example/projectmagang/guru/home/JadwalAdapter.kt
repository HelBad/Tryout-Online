...
import com.example.projectmagang.data.DataJadwal
...
class JadwalAdapter (val context: Context, var dataJadwal: ArrayList<DataJadwal>): RecyclerView.Adapter<JadwalAdapter.ViewHolder>() {
