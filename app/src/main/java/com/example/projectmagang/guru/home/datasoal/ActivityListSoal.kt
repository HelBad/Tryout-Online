...
class ActivityListSoal : AppCompatActivity() {
    ...
    fun getSoal(id: Int){
        ApiService.endpoint.mapelSoal(id).enqueue(object : Callback<ResponseListDataSoal> {
    ...
    fun hapusSoal(id: Int, position: Int, dataSoal: DataSoal) {
        ...
        dialog.setPositiveButton("Hapus"){dialog, which ->
            ApiService.endpoint.deleteSoal(id).enqueue(object : Callback<ResponseMessage> {
