...
import com.example.projectmagang.data.DataSiswa
...
class ActivitySiswaGuru : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvSiswa.apply {
            ...
            siswaGuruAdapter.setOnDetailCallback(object :
                SiswaGuruAdapter.OnItemClickCallback {
    ...
    fun getSiswa(id_mapel: Int) {
        ApiService.endpoint.siswaGuru(id_mapel).enqueue(object : Callback<ResponseListDataSiswa> {
