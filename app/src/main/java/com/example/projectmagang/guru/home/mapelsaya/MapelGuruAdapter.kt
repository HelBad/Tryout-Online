package com.example.projectmagang.guru.home.mapelsaya
...
class MapelGuruAdapter (val context : Context, var dataMapel: ArrayList<DataMapel>): RecyclerView.Adapter<MapelGuruAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if(position == 0) {
            ...
            holder.bing(dataMapel[position], dataMapel[position-1].nama_kelas)
        }
