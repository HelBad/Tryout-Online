package com.example.projectmagang.guru.home.datasoal
...
import com.example.projectmagang.data.DataSoal
import kotlinx.android.synthetic.main.cardsoal.view.*

class ListSoalAdapter (val context: Context, var dataSoal : ArrayList<DataSoal>): RecyclerView.Adapter<ListSoalAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.view.detailSoal.setOnClickListener {
            onDetail.onItemClicked(dataSoal[position],position)
        }
        holder.view.btn_delete_soal.setOnClickListener {
            onDelete.onItemClicked(dataSoal[position],position)
        }
        holder.view.btn_edit_soal.setOnClickListener {
            onEdit.onItemClicked(dataSoal[position], position)
        }
    }
